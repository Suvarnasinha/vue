<template>
  <div class="root">
    ...
    <p>
      ...
      Reading <input type="checkbox" value="reading" v-model="formData.hobbies" @change="v$.hobbies.$touch()" />
      Traveling <input type="checkbox" value="traveling" v-model="formData.hobbies" @change="v$.hobbies.$touch()" />
      Sports <input type="checkbox" value="sports" v-model="formData.hobbies" @change="v$.hobbies.$touch()" />
...
const rules = {
  ...
  confirm: { required, sameAsPassword: sameAs(() => formData.password) },
  bool: { required },
  car: { required },
  hobbies: { required }
}
